...
class DetailSeriesFragment : Fragment() {
    ...
    private val viewModel: DetailSeriesViewModel by viewModel()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getAllDetailSeries(seriesId)
        viewModel.checkFavorite(seriesId)

        viewModel.detailSeries.observe(viewLifecycleOwner) { resource ->
            when (resource.status) {
                ...
                Status.SUCCESS -> {
                    ...
                    binding.apply {
                        tvJudul.text = resource.data?.name
                        tvTitle.text = resource.data?.name
        ...
        binding.ivFav.setOnClickListener {
            addFavorite(seriesId,name,image)
        }
